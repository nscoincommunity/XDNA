...
QFontDatabase::addApplicationFont(":/fonts/nscoin_font");

QString windowTitle = tr("NSCOIN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NSCOIN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and NSCOIN: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About NSCOIN Core"), this);
    aboutAction->setStatusTip(tr("Show information about NSCOIN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NSCOIN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NSCOIN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NSCOIN addresses"));
    ...
    openAction->setStatusTip(tr("Open a NSCOIN: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the NSCOIN Core help message to get a list with possible NSCOIN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("NSCOIN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NSCOIN network", "", count));
}
...
{
    QString strTitle = tr("NSCOIN Core"); // default title
