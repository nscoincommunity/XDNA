...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("NSCOIN Core nscoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded NSCOIN transaction") + "\n" +
                               "  nscoin-tx [options] -create [commands]   " + _("Create hex-encoded NSCOIN transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded NSCOIN transaction
