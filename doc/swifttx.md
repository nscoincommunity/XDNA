...
* WebSocket: [https://github.com/NSCOIN-Core/insight-api-nscoin#web-socket-api](https://github.com/NSCOIN-Core/insight-api-nscoin#web-socket-api)
* API: [https://github.com/NSCOIN-Core/insight-api-nscoin#swifttx-transactions](https://github.com/NSCOIN-Core/insight-api-nscoin#swifttx-transactions)
...
By default, the NSCOIN Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the NSCOIN Core daemon:
