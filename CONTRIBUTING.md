Contributing to NSCOIN Core
============================

The NSCOIN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the NSCOIN Core project, and is not to be
confused with overall NSCOIN Network Protocol consensus changes.

Whether a pull request is merged into NSCOIN Core rests with the project merge
...
Patches that change NSCOIN consensus rules are considerably more involved than
...
Where a patch set proposes to change the NSCOIN consensus, it must have been
...
The project leader is the release manager for each NSCOIN Core release.
